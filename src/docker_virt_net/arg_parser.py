...
def parse_args():
    ...
    parser.add_argument("-r", "--remove", action = 'store_true', help = "Remove the instances of elements found on <net_definition>")
    parser.add_argument("--log", nargs = '?', default = "INFO", type = _log_level_check, help = "Log level (DEBUG | INFO | WARNING | ERROR | CRITICAL)")
